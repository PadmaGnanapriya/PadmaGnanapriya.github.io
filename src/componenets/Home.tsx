...
const Home: React.FC = () => {
  ...
  useEffect(() => {
    if ((window.outerHeight - window.innerHeight) > 160 || (window.outerWidth - window.innerWidth) > 100) {
      (navigator.onLine) ?
        window.open("https://www.google.com/search?source=hp&ei=VesOYI2cAaWhmgeesKPQCA&q=Padma+Gnanapriya&oq=Padma+Gnanapriya&gs_lcp=&sclient=psy-ab&ved=0ahUKEwjNmoizurfuAhWlkOYKHR7YCIoQ4dUDCAY&uact=5", "_self") : window.close();
    }
  })
