...
const Footer: React.FC = () => {
  ...
  return (
    <div className={`'py-4' ${isDark ? 'footer-dark' : 'footer-light'}`}>
      <Row className="p-icon px-3" style={{ margin: 'auto'}}>
