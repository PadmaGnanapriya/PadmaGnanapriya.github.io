...
const SlideNav: React.FC = () => {
  ...
  const renderList = () => myList.map((item) => <li key={item.view}><Link activeClass={"active"}
                                                                          className={`${item.value} myLink`}
                                                                          to={item.value} spy={true}
                                                                          smooth={true}
                                                                          duration={500}>{item.view}</Link></li>)
